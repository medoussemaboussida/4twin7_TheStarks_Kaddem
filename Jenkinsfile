...
def success() {
    ...
    emailext(
        ...
        to: 'ghassenbenmahmoud3@gmail.com',
        from: 'ghassenbenmahmoud3@gmail.com',
        replyTo: 'ghassenbenmahmoud3@gmail.com',
        mimeType: 'text/html'
    )
...
pipeline {
 ...
 stage('MVN CLEAN') {
        ...
        stage('JaCoCo coverage report') {
         ...
         stage('Docker Image') {
            steps {
                sh 'docker build -t medoussemaboussida/kaddem:1.0.0 .'
            }
        }
        stage('Docker Login') {
            steps {
        ...
        stage('Push Docker Image') {
            steps {
                sh 'docker push  medoussemaboussida/kaddem:1.0.0'
            }
        }
